...
def dynamic_pipline(start_date_str, required_days, original_news_path, extracted_data_path, fusion_data_path):
    get_news.get_tushare_news_n_days(start_date_str, required_days, original_news_path)
