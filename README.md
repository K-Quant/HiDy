...
[[Arxiv Paper]]()
[[Open Database]](https://zenodo.org/record/8117217)
...
- We have published the 1.0 version of the hierachical dynamic financial knowlegde base `HiDy` in [Zenedo](https://zenodo.org/record/8117217).
...
# Description
Our databases is open-access and available in [Zenedo](https://zenodo.org/record/8117217)! The data description is shown in the following table:
